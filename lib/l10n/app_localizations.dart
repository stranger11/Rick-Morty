...
abstract class AppLocalizations {
  ...
  /// No description provided for @failedToLoadCharacters.
  ///
  /// In en, this message translates to:
  /// **'Failed to load characters'**
  String get failedToLoadCharacters;

  /// No description provided for @failedToLoadMoreCharacters.
  ///
  /// In en, this message translates to:
  /// **'Failed to load more characters'**
  String get failedToLoadMoreCharacters;

  /// No description provided for @rateLimitRepeatInSeconds.
  ///
  /// In en, this message translates to:
  /// **'Rate limit. Repeat in {seconds} sec.'**
  ...
  /// In en, this message translates to:
  /// **'Character details'**
  String get characterDetailsTitle;
  ...
  /// No description provided for @failedToLoadCharacterDetails.
  ///
  /// In en, this message translates to:
